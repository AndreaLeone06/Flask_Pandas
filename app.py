...
gdfRip = gpd.read_file('Limiti/ripartizioni/RipGeo01012021_WGS84.shp')
gdfReg = gpd.read_file('Limiti/regioni/Reg01012021_WGS84.shp')
gdfProv = gpd.read_file('Limiti/province/ProvCM01012021_WGS84.shp')
gdfCom = gpd.read_file('Limiti/comuni/Com01012021_WGS84.shp')
